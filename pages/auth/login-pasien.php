    ...
    <div class="card-body">
      ...
      <form action="" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Username" name="nama" value="">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Password" name="alamat" value="">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <?php if (isset($_SESSION['error'])) : ?>
              <p style="color: red; font-style: italic; margin-bottom: 1rem;"><?php echo $_SESSION['error']; unset($_SESSION['error']); ?></p>
        <?php endif ?>
        <div class="row">
          <div class="col-8">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button id="klik"  name="klik" type="submit" class="btn btn-primary btn-block">Sign In</button>
          </div>
          <div>
            <a href="http://<?= $_SERVER['HTTP_HOST'] ?>/poliklinik/pages/auth/register.php">I don't have account</a>
          </div=>
          <!-- /.col -->
        </div>
      </form>
